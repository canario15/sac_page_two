...
ActiveRecord::Schema.define(version: 2019_07_15_230837) do
  ...
  create_table "championships", force: :cascade do |t|
    ...
    t.index ["sub_category_id"], name: "index_championships_on_sub_category_id"
  end
  ...
  create_table "race_results", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["pilot_id"], name: "index_race_results_on_pilot_id"
  ...
  add_foreign_key "championships", "sub_categories"
